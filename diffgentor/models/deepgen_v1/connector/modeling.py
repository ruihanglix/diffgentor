...
"""Connector model for DeepGen - bridges LLM to DiT."""
...
class ConnectorEncoder(nn.Module):
    """Connector encoder that bridges LLM hidden states to DiT.

    This module takes the concatenated hidden states from multiple LLM layers
    and transforms them into embeddings suitable for the DiT model.
    """
    ...
    def forward(self, inputs_embeds: torch.Tensor) -> torch.Tensor:
        """Forward pass through the connector encoder.
